...
def generate_pair_stats(primer_pair, count, short_products_cutoff=SHORT_PRODUCTS_CUTOFF):
    ...
    report.append("Number of viable pcr products:\t{}\t{0:.1%}".format(str(count["viable_products"]), viable_products_ratio))
    number_of_no_viable_products_removed = count["total_products"] - count["viable_products"]
    report.append("Number of short products:\t{}\t{0:.1%}".format(str(number_of_no_viable_products_removed),
    ...
    report.append("Ratio euchromatin (without mixed):\t{0:.1%}".format(count["euchromatin_products"] / (count["viable_products"] - count["mixed_products"])))
    report.append("Ratio heterochromatin (without mixed):\t{0:.1%}".format(count["heterochromatin_products"] / (count["viable_products"] - count["mixed_products"])))
